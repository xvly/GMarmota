...
#ifdef REQUIRE_VS_WORLD_TANGENT
#   define VS_WORLD_TANGENT(a, v) a.worldTangent = UnityObjectToWorldNormal(v.tangent);
#else
...
// pixel shader.
#define V2F_VERTEX_ATTRIBUTES(semantic1, semantic2, semantic3, semantic4, semantic5, semantic6) \
...
#define TRANSFER_VERTEX_ATTRIBUTES(o, a) \
...
#define CALCULATE_PIXEL_ATTRIBUTES(a, i) \
