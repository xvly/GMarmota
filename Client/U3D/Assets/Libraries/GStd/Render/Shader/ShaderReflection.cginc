...
{
    // Cubemap
#if ENABLE_REFLECTION_CUBEMAP
    fixed4 cubemap = UNITY_SAMPLE_TEXCUBE(_ReflectionCubemap, viewReflect);
#else
    ...
    finalColor.rgb = lerp(finalColor.rgb, cubemap.rgb, reflectionOpacity);
}
