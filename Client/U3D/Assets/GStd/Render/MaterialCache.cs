namespace GStd
{
    ...
    public sealed class MaterialCache : Singleton<MaterialCache>
    {
        ...
        {
            foreach (KeyValuePair<Struct6, Material> pair in Singleton<MaterialCache>.Instance.dictionary_0)
            {
            ...
            Singleton<MaterialCache>.Instance.dictionary_0.Clear();
